...
void Default_Handler(void); /* unused/default handler */
...
__attribute__((naked)) void HardFault_Handler(void) {
	...
	*	 MOV sp,%0 	- move the value of the first element of the argument to the stack pointer
	*  : : "r" 		- the argument expected is a register
	*  (&__stack_end__)	- the address of the stack limit
	*/
